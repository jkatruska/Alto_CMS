         ...
         $validation = $validate->check($_POST, array(
          ...
          if($validation->passed()){
              ...
              try{
                  ...
                  Redirect::to('?page=updateModules.php&id='.$id);
              }
              catch(Exception $e){
                  die($e->getMessage());
              }
...
?>
 ...
 <div class="insert">
    <form action ="" method="POST" enctype="multipart/form-data">
        <input type="text" name="title" placeholder="Modul" class="insert_input" autocomplete="off" value="<?= $single[0]->name ?>"><br>
        <textarea name="text" id="text" placeholder="Popis modulu"><?= br2nl($single[0]->text) ?></textarea><br>
